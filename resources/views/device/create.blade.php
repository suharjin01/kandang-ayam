<x-layout>
    ...
    <section class="bg-gray-2 rounded-xl">
        <div class="p-8 shadow-lg">
            <form class="space-y-4" method="POST" action="/device/store">
                @csrf
                @method("POST")
                <div class="w-full">
                    <label class="sr-only" for="serial_number">Serial Number</label>
                    <input class="input input-solid max-w-full" placeholder="Serial Number" type="text" id="serial_number" name="serial_number" value="{{ old('serial_number') }}"/>
                    @error('serial_number')
                  ...
                  <div class="w-full">
                    ...
                    <input class="input input-solid max-w-full" placeholder="Meta Data" type="text" id="meta_data" name="meta_data" value="{{ old('meta_data') }}"/>
                    @error('meta_data')
