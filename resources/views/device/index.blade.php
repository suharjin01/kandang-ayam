<x-layout>
    ...
    <div class="container d-flex justify-content-between">
        <a href="/device/create" class="btn btn-outline-secondary">Tambah Data Device</a>
    </div><br>
    ...
    <div class="my-4 flex w-full overflow-x-auto">
        <table class="table-zebra table">
            ...
            <tbody>
                ...
                <tr>
                    <th>{{ ($device->currentPage() - 1) * $device->perPage() + $loop->index +1 }}</th>
                    ...
                    <td>
                        <div class="gap-1">
                            <form action="/device/delete/{{ $item->id }}" method="POST">
                                @csrf
                                @method("DELETE")
                                <a href="/device/edit/{{ $item->id }}" class="btn btn-outline-warning">Ubah</a>
    ...
    {{ $device->links('pagination::tailwind') }}
</x-layout>
