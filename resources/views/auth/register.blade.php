...
<body class="flex items-center justify-center
    ...
    transition-transform w-96 text-center">
        ...
        <form action="/register" method="post">
            @csrf
            @method('POST')
            <label for="name" class="block mt-4 mb-2 text-left text-gray-700 font-bold">Nama Lengkap:</label>
            ...
            <label for="konf_password" class="block mb-2 text-left text-gray-700 font-bold">Konfirmasi Password:</label>
            <input type="password" id="konf_password" name="password_confirmation" placeholder="Enter your Password"
                class="block w-full mb-6 px-4 py-2 border
                border-gray-300 rounded-md focus:outline-none
                 focus:border-green-400"
                required>
